"""
Original code posted by yaohungpt from https://github.com/yaohungt/Multimodal-Transformerlicensed.
"""
import torch
from torch import nn
import torch.nn.functional as F

from models.module_for_crossattention.PositionalEmbedding import *
from models.module_for_crossattention.MultiheadAttention import *
import math
...
if __name__ == '__main__':
    ...
    encoder = TransformerEncoder(768, 4, 2)
    x =  torch.tensor(torch.rand(128, 10, 768))
    #proj_x = x.permute(1,0,2)
